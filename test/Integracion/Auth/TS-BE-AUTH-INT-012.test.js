...
describe('TS-INT-AUTH-001 - Test de Integración: Login Coordinador', () => {
  ...
  test('INT-001: Login exitoso devuelve estructura completa con token y usuario', async () => {
    ...
    console.log('INT PASS: Estructura de respuesta completa para Coordinador');
  });
  ...
  test('INT-003: Contraseña incorrecta retorna 401 sin token', async () => {
    ...
    console.log('INT PASS: Contraseña incorrecta rechazada para Coordinador');
  });
  ...
  test('INT-004: Email inexistente retorna error apropiado', async () => {
    ...
    console.log('INT PASS: Email inexistente rechazado para Coordinador');
  });
  ...
  test('INT-005: Respuesta NO contiene contraseña en ningún formato', async () => {
    ...
    console.log('INT PASS: Contraseña no expuesta en respuesta para Coordinador');
  });
  ...
  test('INT-006: Request sin email retorna error con mensaje descriptivo', async () => {
    ...
    console.log('INT PASS: Validación de email requerido para Coordinador');
  });
  ...
  test('INT-007: Request sin password retorna error con mensaje descriptivo', async () => {
    ...
    console.log('INT PASS: Validación de contraseña requerida para Coordinador');
  });
  ...
  test('INT-009: Request sin Authorization header es rechazado en endpoint protegido', async () => {
    ...
    console.log('INT PASS: Acceso sin token manejado para recursos de Coordinador');
  });
  ...
  test('INT-011: Respuesta contiene content-type JSON', async () => {
    ...
    console.log('INT PASS: Content-Type correcto en respuesta Coordinador');
  });
  ...
  test('INT-012: Rol del usuario es retornado en la respuesta', async () => {
    ...
    console.log('INT PASS: Estructura de usuario presente en respuesta Coordinador');
  });
