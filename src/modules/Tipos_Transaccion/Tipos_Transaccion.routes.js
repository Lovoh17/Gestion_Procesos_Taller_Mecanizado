...
import {crearTipoTransaccion, obtenerTiposTransaccion, obtenerTipoTransaccionPorId, actualizarTipoTransaccion, eliminarTipoTransaccion} from "./Tipos_Transaccion.controller.js";
const router = Router();
