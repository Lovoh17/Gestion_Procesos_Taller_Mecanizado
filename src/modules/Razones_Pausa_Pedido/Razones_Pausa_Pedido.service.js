import { Razones_Pausa_Pedido } from "./Razones_Pausa_Pedido.js";

class RazonesPausaPedidoService{
    async getAll() {
            try {
                const razones_pausa_pedido = await Razones_Pausa_Pedido.findAll();
        ...
        async getById(id) {
            try {
                const razones_pausa_pedido = await Razones_Pausa_Pedido.findByPk(id);
        ...
        async create(data) {
            try {
                const razones_pausa_pedido = await Razones_Pausa_Pedido.create(data);
                return razones_pausa_pedido;
            } catch (error) {
