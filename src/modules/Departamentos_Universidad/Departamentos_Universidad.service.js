import { DepartamentosUniversidad} from "./Departamentos_Universidad.js";

class DepartamentoUniversidadService{
    async getAll() {
            try {
                const departamento_universidad = await DepartamentosUniversidad.findAll();
        ...
        async getById(id) {
            try {
                const departamento_universidad = await DepartamentosUniversidad.findByPk(id);
                if (!zonaTrabajo) {
        ...
        async create(data) {
            try {
                const nuevoDepartamento = await DepartamentosUniversidad.create(data);
